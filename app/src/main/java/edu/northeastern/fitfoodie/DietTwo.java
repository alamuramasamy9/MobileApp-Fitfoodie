...
//        quantityOfFoodConsumed = findViewById(R.id.foodQuantityConsumed);
//
//        //reference for submit button in the layout
//        submitButtonAfterProvidingInfo = findViewById(R.id.submitButton);
//
//        //reference fot the text views in the layout
//        foodName = findViewById(R.id.foodNameConsumedTextView);
//        foodQuantity = findViewById(R.id.foodQuantityConsumedTextView);
//        caloriesConsumed = findViewById(R.id.caloriesConsumedTextView);
//        fatConsumed = findViewById(R.id.fatConsumedTextView);
...
//        {
//
////            Intent new_intent = new Intent(DietTwo.this, DietTwo.class);
////            startActivity(new_intent);
//
//
//            if (foodConsumed == null || quantityOfFoodConsumed == null) {
//                resetData();
//                Snackbar snack = Snackbar.make(view, "Provide all the reqquired information", Snackbar.LENGTH_LONG).setAction("Action", null);
...
//
//            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
//            DatabaseReference nutrition_ref = databaseReference.child("Users").child("alamu").child("nutrition");
//
//            //setting up the url
//            String queryString = "fries";
//            String urlString = "https://api.api-ninjas.com/v1/nutrition?query=" +queryString;
//
//
...
//
//                    // TODO: Render response on the screen here.
//                    List<FoodItem> foods = new ArrayList<>();
//                    // initialize the list with the data provided
//                    for (int i = 0; i < jsonArray.length(); i++) {
//                        JSONObject jsonObject = jsonArray.getJSONObject(i);
//
//                        Gson gson = new Gson();
...
//                        nutrition_ref.child(currentTime.toString()).setValue(jsonMap);
//
////                        Toast.makeText(this, "Saved to database", Toast.LENGTH_LONG).show();
//
//                        Log.i("Firebase", "Saved to database");
//                        // Create FoodItem object from JSON object
//                        FoodItem foodItem = new FoodItem();
//                        foodItem.setName(jsonObject.getString("name"));
//                        foodItem.setCalories(jsonObject.getDouble("calories"));
...
//                    }
//
//                    // to render the consumed food name and food quantity
//                    String itemNames = "FOOD NAME: " + foods.stream().map(FoodItem::getName);
//                    String quantity = "QUAN: " + foods.stream().map(FoodItem::getServingSize);
//
////            // to calculate the total calorie count, total fat count and total protein count
//                    double totalCalories = foods.stream().mapToDouble(FoodItem::getCalories).sum();
//                    double totalFat = foods.stream().mapToDouble(FoodItem::getTotalFat).sum();
//                    double totalProtein = foods.stream().mapToDouble(FoodItem::getProtein).sum();
////
...
//            foodName.setText(itemNames);
//            foodQuantity.setText(quantity);
//            caloriesConsumed.setText("TOTAL CALORIEEESS: " +String.format("%.1f",totalCalories));
//            fatConsumed.setText("TOTAL FATTTTT:" + String.format("%.1f", totalFat));
//            proteinConsumed.setText("TOTAL PROTEINNNNN: " +String.format("%.1f", totalProtein));
//        });
//    }
//
//    private void resetData() {
//        foodConsumed.setText("");
//        quantityOfFoodConsumed.setText("");
//    }
//
//
//}